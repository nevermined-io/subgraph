import {
  ...
  Initialized as NFT721AccessTemplateInitializedEvent,
...
import {
  ...
  NFT721AccessTemplateInitialized,
...
export function handleNFT721AccessTemplateInitialized(
  event: NFT721AccessTemplateInitializedEvent
): void {
  let entity = new NFT721AccessTemplateInitialized(
    event.transaction.hash.toHex() + "-" + event.logIndex.toString()
  )
