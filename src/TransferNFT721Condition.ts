import {
  ...
  Initialized as TransferNFT721ConditionInitializedEvent,
...
import {
  ...
  TransferNFT721ConditionInitialized,
...
export function handleTransferNFT721ConditionInitialized(
  event: TransferNFT721ConditionInitializedEvent
): void {
  let entity = new TransferNFT721ConditionInitialized(
    event.transaction.hash.toHex() + "-" + event.logIndex.toString()
  )
