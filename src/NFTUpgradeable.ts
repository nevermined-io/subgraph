import {
  ...
  Initialized as NFTUpgradeableInitializedEvent,
...
export function handleNFTUpgradeableInitialized(
  event: NFTUpgradeableInitializedEvent
): void {
  let entity = new NFTUpgradeableInitialized(
    event.transaction.hash.toHex() + "-" + event.logIndex.toString()
  )
