import {
  ...
  Initialized as DIDRegistryInitializedEvent,
...
export function handleDIDRegistryInitialized(
  event: DIDRegistryInitializedEvent
): void {
  let entity = new DIDRegistryInitialized(
    event.transaction.hash.toHex() + "-" + event.logIndex.toString()
  )
