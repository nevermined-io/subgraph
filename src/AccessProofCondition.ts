import {
  ...
  Initialized as AccessProofConditionInitializedEvent,
...
import {
  ...
  AccessProofConditionInitialized,
...
export function handleAccessProofConditionInitialized(
  event: AccessProofConditionInitializedEvent
): void {
  let entity = new AccessProofConditionInitialized(
    event.transaction.hash.toHex() + "-" + event.logIndex.toString()
  )
