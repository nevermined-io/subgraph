...
export class NFT721SalesTemplate__getAgreementDataResult {
  value0: Address;
  value1: Address;
...
export class NFT721SalesTemplate extends ethereum.SmartContract {
  ...
  getAgreementData(_id: Bytes): NFT721SalesTemplate__getAgreementDataResult {
    ...
    return new NFT721SalesTemplate__getAgreementDataResult(
      result[0].toAddress(),
      result[1].toAddress()
    );
  }
  ...
  try_getAgreementData(
    _id: Bytes
  ): ethereum.CallResult<NFT721SalesTemplate__getAgreementDataResult> {
    ...
    return ethereum.CallResult.fromValue(
      new NFT721SalesTemplate__getAgreementDataResult(
        value[0].toAddress(),
        value[1].toAddress()
      )
    );
