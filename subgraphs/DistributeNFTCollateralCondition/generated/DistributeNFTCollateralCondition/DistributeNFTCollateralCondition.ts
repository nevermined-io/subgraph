...
export class DistributeNFTCollateralCondition extends ethereum.SmartContract {
  static bind(address: Address): DistributeNFTCollateralCondition {
    return new DistributeNFTCollateralCondition(
