...
export class ThresholdCondition extends ethereum.SmartContract {
  static bind(address: Address): ThresholdCondition {
    return new ThresholdCondition("ThresholdCondition", address);
  }
  ...
  fulfill(
    ...
    let result = super.call(
      "fulfill",
      "fulfill(bytes32,bytes32[],uint256):(uint8)",
      [
        ethereum.Value.fromFixedBytes(_agreementId),
        ethereum.Value.fromFixedBytesArray(_inputConditions),
