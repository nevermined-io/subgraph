...
export class NFTSalesWithDLEQTemplate__getAgreementDataResult {
  value0: Address;
  value1: Address;
  value2: Bytes;
...
export class NFTSalesWithDLEQTemplate extends ethereum.SmartContract {
  static bind(address: Address): NFTSalesWithDLEQTemplate {
    return new NFTSalesWithDLEQTemplate("NFTSalesWithDLEQTemplate", address);
  }
  ...
  getAgreementData(
    _id: Bytes
  ): NFTSalesWithDLEQTemplate__getAgreementDataResult {
    let result = super.call(
      "getAgreementData",
    ...
    return new NFTSalesWithDLEQTemplate__getAgreementDataResult(
      result[0].toAddress(),
      result[1].toAddress(),
      result[2].toBytes()
    );
  ...
  try_getAgreementData(
    _id: Bytes
  ): ethereum.CallResult<NFTSalesWithDLEQTemplate__getAgreementDataResult> {
    let result = super.tryCall(
      "getAgreementData",
      "getAgreementData(bytes32):(address,address,bytes32)",
      [ethereum.Value.fromFixedBytes(_id)]
    ...
    return ethereum.CallResult.fromValue(
      new NFTSalesWithDLEQTemplate__getAgreementDataResult(
        value[0].toAddress(),
        value[1].toAddress(),
        value[2].toBytes()
      )
