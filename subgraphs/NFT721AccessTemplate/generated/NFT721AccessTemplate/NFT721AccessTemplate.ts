...
export class NFT721AccessTemplate__getAgreementDataResult {
  value0: Address;
  value1: Address;
...
export class NFT721AccessTemplate extends ethereum.SmartContract {
  static bind(address: Address): NFT721AccessTemplate {
    return new NFT721AccessTemplate("NFT721AccessTemplate", address);
  }
  ...
  getAgreementData(_id: Bytes): NFT721AccessTemplate__getAgreementDataResult {
    let result = super.call(
      "getAgreementData",
    ...
    return new NFT721AccessTemplate__getAgreementDataResult(
      result[0].toAddress(),
      result[1].toAddress()
    );
  }
  ...
  try_getAgreementData(
    _id: Bytes
  ): ethereum.CallResult<NFT721AccessTemplate__getAgreementDataResult> {
    let result = super.tryCall(
      "getAgreementData",
      "getAgreementData(bytes32):(address,address)",
      [ethereum.Value.fromFixedBytes(_id)]
    ...
    return ethereum.CallResult.fromValue(
      new NFT721AccessTemplate__getAgreementDataResult(
        value[0].toAddress(),
        value[1].toAddress()
      )
    );
