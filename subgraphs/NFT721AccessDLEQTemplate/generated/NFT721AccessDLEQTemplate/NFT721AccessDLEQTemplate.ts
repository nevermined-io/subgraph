...
export class NFT721AccessDLEQTemplate__getAgreementDataResult {
  value0: Address;
  value1: Address;
  value2: Bytes;
...
export class NFT721AccessDLEQTemplate extends ethereum.SmartContract {
  static bind(address: Address): NFT721AccessDLEQTemplate {
    return new NFT721AccessDLEQTemplate("NFT721AccessDLEQTemplate", address);
  }
  ...
  getAgreementData(
    _id: Bytes
  ): NFT721AccessDLEQTemplate__getAgreementDataResult {
    let result = super.call(
      "getAgreementData",
    ...
    return new NFT721AccessDLEQTemplate__getAgreementDataResult(
      result[0].toAddress(),
      result[1].toAddress(),
      result[2].toBytes()
    );
  ...
  try_getAgreementData(
    _id: Bytes
  ): ethereum.CallResult<NFT721AccessDLEQTemplate__getAgreementDataResult> {
    let result = super.tryCall(
      "getAgreementData",
      "getAgreementData(bytes32):(address,address,bytes32)",
      [ethereum.Value.fromFixedBytes(_id)]
    ...
    return ethereum.CallResult.fromValue(
      new NFT721AccessDLEQTemplate__getAgreementDataResult(
        value[0].toAddress(),
        value[1].toAddress(),
        value[2].toBytes()
      )
