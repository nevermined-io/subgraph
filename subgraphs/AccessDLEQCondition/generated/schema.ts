...
export class Fulfilled extends Entity {
  ...
  set _cipher(value: BigInt) {
    this.set("_cipher", Value.fromBigInt(value));
  }

  get _secretId(): Array<BigInt> {
    let value = this.get("_secretId");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
  ...
  set _secretId(value: Array<BigInt>) {
    this.set("_secretId", Value.fromBigIntArray(value));
  }
  ...
  set _reencrypt(value: Array<BigInt>) {
    this.set("_reencrypt", Value.fromBigIntArray(value));
  }
  ...
  set _proof(value: Array<BigInt>) {
    this.set("_proof", Value.fromBigIntArray(value));
  }
