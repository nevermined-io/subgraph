...
export class AccessDLEQCondition__g1ResultValue0Struct extends ethereum.Tuple {
  get x(): BigInt {
...
export class AccessDLEQCondition extends ethereum.SmartContract {
  static bind(address: Address): AccessDLEQCondition {
    return new AccessDLEQCondition("AccessDLEQCondition", address);
  }
  ...
  fulfill(
    ...
    let result = super.call(
      "fulfill",
      "fulfill(bytes32,uint256,uint256[2],uint256[2],uint256[2],uint256[2],uint256[2]):(uint8)",
      [
  ...
  g1(): AccessDLEQCondition__g1ResultValue0Struct {
    let result = super.call("g1", "g1():((uint256,uint256))", []);

    return changetype<AccessDLEQCondition__g1ResultValue0Struct>(
      result[0].toTuple()
    );
  }

  try_g1(): ethereum.CallResult<AccessDLEQCondition__g1ResultValue0Struct> {
    let result = super.tryCall("g1", "g1():((uint256,uint256))", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<AccessDLEQCondition__g1ResultValue0Struct>(value[0].toTuple())
    );
  }
  ...
  hashValues(
    ...
    let result = super.call(
      "hashValues",
      "hashValues(uint256,uint256[2],uint256[2],uint256[2]):(bytes32)",
      [
        ethereum.Value.fromUnsignedBigInt(_cipher),
        ethereum.Value.fromUnsignedBigIntArray(_secretId),
        ethereum.Value.fromUnsignedBigIntArray(_provider),
