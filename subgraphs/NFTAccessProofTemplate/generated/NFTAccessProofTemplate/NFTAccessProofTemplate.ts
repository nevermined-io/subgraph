...
export class NFTAccessProofTemplate__getAgreementDataResult {
  value0: Address;
  value1: Address;
...
export class NFTAccessProofTemplate extends ethereum.SmartContract {
  static bind(address: Address): NFTAccessProofTemplate {
    return new NFTAccessProofTemplate("NFTAccessProofTemplate", address);
  }

  getAgreementData(_id: Bytes): NFTAccessProofTemplate__getAgreementDataResult {
    ...
    return new NFTAccessProofTemplate__getAgreementDataResult(
      result[0].toAddress(),
      result[1].toAddress()
    );
  }
  ...
  try_getAgreementData(
    _id: Bytes
  ): ethereum.CallResult<NFTAccessProofTemplate__getAgreementDataResult> {
    ...
    return ethereum.CallResult.fromValue(
      new NFTAccessProofTemplate__getAgreementDataResult(
        value[0].toAddress(),
        value[1].toAddress()
      )
    );
