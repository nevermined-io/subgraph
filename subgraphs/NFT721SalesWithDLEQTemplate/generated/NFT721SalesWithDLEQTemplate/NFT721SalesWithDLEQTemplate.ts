...
export class NFT721SalesWithDLEQTemplate__getAgreementDataResult {
  value0: Address;
  value1: Address;
  value2: Bytes;
...
export class NFT721SalesWithDLEQTemplate extends ethereum.SmartContract {
  static bind(address: Address): NFT721SalesWithDLEQTemplate {
    return new NFT721SalesWithDLEQTemplate(
  ...
  getAgreementData(
    _id: Bytes
  ): NFT721SalesWithDLEQTemplate__getAgreementDataResult {
    let result = super.call(
      "getAgreementData",
    ...
    return new NFT721SalesWithDLEQTemplate__getAgreementDataResult(
      result[0].toAddress(),
      result[1].toAddress(),
      result[2].toBytes()
    );
  ...
  try_getAgreementData(
    _id: Bytes
  ): ethereum.CallResult<NFT721SalesWithDLEQTemplate__getAgreementDataResult> {
    let result = super.tryCall(
      "getAgreementData",
      "getAgreementData(bytes32):(address,address,bytes32)",
      [ethereum.Value.fromFixedBytes(_id)]
    ...
    return ethereum.CallResult.fromValue(
      new NFT721SalesWithDLEQTemplate__getAgreementDataResult(
        value[0].toAddress(),
        value[1].toAddress(),
        value[2].toBytes()
      )
