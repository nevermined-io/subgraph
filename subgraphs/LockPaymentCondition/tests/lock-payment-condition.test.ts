...
import { Fulfilled as FulfilledEvent } from "../generated/LockPaymentCondition/LockPaymentCondition"
import { handleFulfilled } from "../src/lock-payment-condition"
import { createFulfilledEvent } from "./lock-payment-condition-utils"
...
describe("Describe entity assertions", () => {
  beforeAll(() => {
    ...
    let _rewardAddress = Address.fromString(
