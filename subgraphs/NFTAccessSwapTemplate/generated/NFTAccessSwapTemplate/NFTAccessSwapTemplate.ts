...
export class NFTAccessSwapTemplate__getAgreementDataResult {
  value0: Address;
  value1: Address;
  value2: Bytes;
...
export class NFTAccessSwapTemplate extends ethereum.SmartContract {
  static bind(address: Address): NFTAccessSwapTemplate {
    return new NFTAccessSwapTemplate("NFTAccessSwapTemplate", address);
  }
  ...
  getAgreementData(_id: Bytes): NFTAccessSwapTemplate__getAgreementDataResult {
    let result = super.call(
      "getAgreementData",
    ...
    return new NFTAccessSwapTemplate__getAgreementDataResult(
      result[0].toAddress(),
      result[1].toAddress(),
      result[2].toBytes()
    );
  ...
  try_getAgreementData(
    _id: Bytes
  ): ethereum.CallResult<NFTAccessSwapTemplate__getAgreementDataResult> {
    let result = super.tryCall(
      "getAgreementData",
      "getAgreementData(bytes32):(address,address,bytes32)",
      [ethereum.Value.fromFixedBytes(_id)]
    ...
    return ethereum.CallResult.fromValue(
      new NFTAccessSwapTemplate__getAgreementDataResult(
        value[0].toAddress(),
        value[1].toAddress(),
        value[2].toBytes()
      )
...
export class InitializeCall__Inputs {
  ...
  get _lockPaymentConditionAddress(): Address {
