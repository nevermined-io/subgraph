...
export class NFT721SubscriptionUpgradeable__getMintedEntriesResultValue0Struct extends ethereum.Tuple {
  get tokenId(): BigInt {
...
export class NFT721SubscriptionUpgradeable__getNFTAttributesResult {
  value0: boolean;
  value1: BigInt;
  value2: BigInt;
  value3: string;
...
export class NFT721SubscriptionUpgradeable__royaltyInfoResult {
  value0: Address;
  value1: BigInt;
...
export class NFT721SubscriptionUpgradeable extends ethereum.SmartContract {
  static bind(address: Address): NFT721SubscriptionUpgradeable {
    return new NFT721SubscriptionUpgradeable(
  ...
  getMintedEntries(
    owner: Address
  ): Array<NFT721SubscriptionUpgradeable__getMintedEntriesResultValue0Struct> {
    let result = super.call(
      "getMintedEntries",
      "getMintedEntries(address):((uint256,uint256,uint256)[])",
      [ethereum.Value.fromAddress(owner)]
    );

    return result[0].toTupleArray<
      NFT721SubscriptionUpgradeable__getMintedEntriesResultValue0Struct
    >();
  }

  try_getMintedEntries(
    owner: Address
  ): ethereum.CallResult<
    Array<NFT721SubscriptionUpgradeable__getMintedEntriesResultValue0Struct>
  > {
  ...
  getNFTAttributes(
    tokenId: BigInt
  ): NFT721SubscriptionUpgradeable__getNFTAttributesResult {
    let result = super.call(
      "getNFTAttributes",
    ...
    return new NFT721SubscriptionUpgradeable__getNFTAttributesResult(
      result[0].toBoolean(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toString()
  ...
  > {
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new NFT721SubscriptionUpgradeable__getNFTAttributesResult(
        value[0].toBoolean(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toString()
  ...
  royaltyInfo(
    tokenId: BigInt,
    value: BigInt
  ): NFT721SubscriptionUpgradeable__royaltyInfoResult {
    let result = super.call(
      "royaltyInfo",
    ...
    return new NFT721SubscriptionUpgradeable__royaltyInfoResult(
      result[0].toAddress(),
      result[1].toBigInt()
    );
  }
  ...
  try_royaltyInfo(
    tokenId: BigInt,
    value: BigInt
  ): ethereum.CallResult<NFT721SubscriptionUpgradeable__royaltyInfoResult> {
    let result = super.tryCall(
      "royaltyInfo",
      "royaltyInfo(uint256,uint256):(address,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new NFT721SubscriptionUpgradeable__royaltyInfoResult(
        value[0].toAddress(),
        value[1].toBigInt()
      )
    );
  ...
  whenWasMinted(owner: Address): Array<BigInt> {
    let result = super.call(
      "whenWasMinted",
      "whenWasMinted(address):(uint256[])",
      [ethereum.Value.fromAddress(owner)]
    );
  ...
  try_whenWasMinted(owner: Address): ethereum.CallResult<Array<BigInt>> {
    let result = super.tryCall(
      "whenWasMinted",
      "whenWasMinted(address):(uint256[])",
      [ethereum.Value.fromAddress(owner)]
