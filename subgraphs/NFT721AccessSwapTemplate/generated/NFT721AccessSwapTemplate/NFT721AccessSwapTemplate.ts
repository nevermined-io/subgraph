...
export class NFT721AccessSwapTemplate__getAgreementDataResult {
  value0: Address;
  value1: Address;
...
export class NFT721AccessSwapTemplate extends ethereum.SmartContract {
  static bind(address: Address): NFT721AccessSwapTemplate {
    return new NFT721AccessSwapTemplate("NFT721AccessSwapTemplate", address);
  }

  getAgreementData(
    _id: Bytes
  ): NFT721AccessSwapTemplate__getAgreementDataResult {
    ...
    return new NFT721AccessSwapTemplate__getAgreementDataResult(
      result[0].toAddress(),
      result[1].toAddress()
    );
  }
  ...
  try_getAgreementData(
    _id: Bytes
  ): ethereum.CallResult<NFT721AccessSwapTemplate__getAgreementDataResult> {
    ...
    return ethereum.CallResult.fromValue(
      new NFT721AccessSwapTemplate__getAgreementDataResult(
        value[0].toAddress(),
        value[1].toAddress()
      )
    );
