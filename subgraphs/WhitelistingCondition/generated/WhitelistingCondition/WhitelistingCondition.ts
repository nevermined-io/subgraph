...
export class WhitelistingCondition extends ethereum.SmartContract {
  static bind(address: Address): WhitelistingCondition {
    return new WhitelistingCondition("WhitelistingCondition", address);
  }
