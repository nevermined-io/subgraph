...
export class NFT721SalesWithAccessTemplate__getAgreementDataResult {
  value0: Address;
  value1: Address;
  value2: Bytes;
...
export class NFT721SalesWithAccessTemplate extends ethereum.SmartContract {
  static bind(address: Address): NFT721SalesWithAccessTemplate {
    return new NFT721SalesWithAccessTemplate(
  ...
  getAgreementData(
    _id: Bytes
  ): NFT721SalesWithAccessTemplate__getAgreementDataResult {
    let result = super.call(
      "getAgreementData",
    ...
    return new NFT721SalesWithAccessTemplate__getAgreementDataResult(
      result[0].toAddress(),
      result[1].toAddress(),
      result[2].toBytes()
    );
  ...
  > {
    ...
    return ethereum.CallResult.fromValue(
      new NFT721SalesWithAccessTemplate__getAgreementDataResult(
        value[0].toAddress(),
        value[1].toAddress(),
        value[2].toBytes()
      )
