...
export class EscrowComputeExecutionTemplate__getAgreementDataResult {
  value0: Address;
  value1: Address;
...
export class EscrowComputeExecutionTemplate extends ethereum.SmartContract {
  static bind(address: Address): EscrowComputeExecutionTemplate {
    return new EscrowComputeExecutionTemplate(
  ...
  getAgreementData(
    _id: Bytes
  ): EscrowComputeExecutionTemplate__getAgreementDataResult {
    let result = super.call(
      "getAgreementData",
    ...
    return new EscrowComputeExecutionTemplate__getAgreementDataResult(
      result[0].toAddress(),
      result[1].toAddress()
    );
  }
  ...
  > {
    ...
    return ethereum.CallResult.fromValue(
      new EscrowComputeExecutionTemplate__getAgreementDataResult(
        value[0].toAddress(),
        value[1].toAddress()
      )
    );
...
export class InitializeCall__Inputs {
  ...
  get _computeExecutionConditionAddress(): Address {
