...
export class NFTAccessDLEQTemplate__getAgreementDataResult {
  value0: Address;
  value1: Address;
  value2: Bytes;
...
export class NFTAccessDLEQTemplate extends ethereum.SmartContract {
  static bind(address: Address): NFTAccessDLEQTemplate {
    return new NFTAccessDLEQTemplate("NFTAccessDLEQTemplate", address);
  }
  ...
  getAgreementData(_id: Bytes): NFTAccessDLEQTemplate__getAgreementDataResult {
    let result = super.call(
      "getAgreementData",
    ...
    return new NFTAccessDLEQTemplate__getAgreementDataResult(
      result[0].toAddress(),
      result[1].toAddress(),
      result[2].toBytes()
    );
  ...
  try_getAgreementData(
    _id: Bytes
  ): ethereum.CallResult<NFTAccessDLEQTemplate__getAgreementDataResult> {
    let result = super.tryCall(
      "getAgreementData",
      "getAgreementData(bytes32):(address,address,bytes32)",
      [ethereum.Value.fromFixedBytes(_id)]
    ...
    return ethereum.CallResult.fromValue(
      new NFTAccessDLEQTemplate__getAgreementDataResult(
        value[0].toAddress(),
        value[1].toAddress(),
        value[2].toBytes()
      )
