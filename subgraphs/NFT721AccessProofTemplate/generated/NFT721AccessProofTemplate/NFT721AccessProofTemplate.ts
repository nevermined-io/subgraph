...
export class NFT721AccessProofTemplate__getAgreementDataResult {
  value0: Address;
  value1: Address;
  value2: Bytes;
...
export class NFT721AccessProofTemplate extends ethereum.SmartContract {
  static bind(address: Address): NFT721AccessProofTemplate {
    return new NFT721AccessProofTemplate("NFT721AccessProofTemplate", address);
  }
  ...
  getAgreementData(
    _id: Bytes
  ): NFT721AccessProofTemplate__getAgreementDataResult {
    let result = super.call(
      "getAgreementData",
    ...
    return new NFT721AccessProofTemplate__getAgreementDataResult(
      result[0].toAddress(),
      result[1].toAddress(),
      result[2].toBytes()
    );
  ...
  try_getAgreementData(
    _id: Bytes
  ): ethereum.CallResult<NFT721AccessProofTemplate__getAgreementDataResult> {
    let result = super.tryCall(
      "getAgreementData",
      "getAgreementData(bytes32):(address,address,bytes32)",
      [ethereum.Value.fromFixedBytes(_id)]
    ...
    return ethereum.CallResult.fromValue(
      new NFT721AccessProofTemplate__getAgreementDataResult(
        value[0].toAddress(),
        value[1].toAddress(),
        value[2].toBytes()
      )
