...
export class NFTSalesTemplate__getAgreementDataResult {
  value0: Address;
  value1: Address;
...
export class NFTSalesTemplate extends ethereum.SmartContract {
  static bind(address: Address): NFTSalesTemplate {
    return new NFTSalesTemplate("NFTSalesTemplate", address);
  }

  getAgreementData(_id: Bytes): NFTSalesTemplate__getAgreementDataResult {
    ...
    return new NFTSalesTemplate__getAgreementDataResult(
      result[0].toAddress(),
      result[1].toAddress()
    );
  }
  ...
  try_getAgreementData(
    _id: Bytes
  ): ethereum.CallResult<NFTSalesTemplate__getAgreementDataResult> {
    ...
    return ethereum.CallResult.fromValue(
      new NFTSalesTemplate__getAgreementDataResult(
        value[0].toAddress(),
        value[1].toAddress()
      )
    );
