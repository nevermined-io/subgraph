...
export class AaveCollateralDepositCondition extends ethereum.SmartContract {
  static bind(address: Address): AaveCollateralDepositCondition {
    return new AaveCollateralDepositCondition(
  ...
  hashValues(
    ...
    _delegatedAsset: Address,
    _delegatedAmount: BigInt,
    _interestRateMode: BigInt
  ): Bytes {
    let result = super.call(
      "hashValues",
      "hashValues(bytes32,address,address,uint256,address,uint256,uint256):(bytes32)",
      [
        ...
        ethereum.Value.fromAddress(_delegatedAsset),
        ethereum.Value.fromUnsignedBigInt(_delegatedAmount),
...
export class FulfillCall__Inputs {
  ...
  get _delegatedAsset(): Address {
    return this._call.inputValues[5].value.toAddress();
  }

  get _delegatedAmount(): BigInt {
