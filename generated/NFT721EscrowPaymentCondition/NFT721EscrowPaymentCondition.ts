...
export class NFT721EscrowPaymentCondition extends ethereum.SmartContract {
  static bind(address: Address): NFT721EscrowPaymentCondition {
    return new NFT721EscrowPaymentCondition(
