...
export class ComputeExecutionCondition extends ethereum.SmartContract {
  static bind(address: Address): ComputeExecutionCondition {
    return new ComputeExecutionCondition("ComputeExecutionCondition", address);
  }
  ...
  fulfill(_agreementId: Bytes, _did: Bytes, _computeConsumer: Address): i32 {
    let result = super.call(
      "fulfill",
  ...
  hashValues(_did: Bytes, _computeConsumer: Address): Bytes {
    let result = super.call(
      "hashValues",
  ...
  wasComputeTriggered(_did: Bytes, _computeConsumer: Address): boolean {
    let result = super.call(
      "wasComputeTriggered",
      "wasComputeTriggered(bytes32,address):(bool)",
      [
        ethereum.Value.fromFixedBytes(_did),
        ethereum.Value.fromAddress(_computeConsumer)
      ]
