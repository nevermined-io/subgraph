...
export class NFT721HolderCondition extends ethereum.SmartContract {
  static bind(address: Address): NFT721HolderCondition {
    return new NFT721HolderCondition("NFT721HolderCondition", address);
  }
