...
export class AaveCollateralWithdrawCondition extends ethereum.SmartContract {
  static bind(address: Address): AaveCollateralWithdrawCondition {
    return new AaveCollateralWithdrawCondition(
