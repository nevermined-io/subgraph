...
export class TransferDIDOwnershipCondition extends ethereum.SmartContract {
  static bind(address: Address): TransferDIDOwnershipCondition {
    return new TransferDIDOwnershipCondition(
  ...
  fulfill(_agreementId: Bytes, _did: Bytes, _receiver: Address): i32 {
    let result = super.call(
      "fulfill",
  ...
  hashValues(_did: Bytes, _receiver: Address): Bytes {
    let result = super.call(
      "hashValues",
  ...
  try_hashValues(_did: Bytes, _receiver: Address): ethereum.CallResult<Bytes> {
    let result = super.tryCall(
      "hashValues",
      "hashValues(bytes32,address):(bytes32)",
      [
