...
export class AccessProofTemplate__getAgreementDataResult {
  value0: Address;
  value1: Address;
...
export class AccessProofTemplate extends ethereum.SmartContract {
  ...
  getAgreementData(_id: Bytes): AccessProofTemplate__getAgreementDataResult {
    ...
    return new AccessProofTemplate__getAgreementDataResult(
      result[0].toAddress(),
      result[1].toAddress()
    );
  }
  ...
  try_getAgreementData(
    _id: Bytes
  ): ethereum.CallResult<AccessProofTemplate__getAgreementDataResult> {
    let result = super.tryCall(
      "getAgreementData",
      "getAgreementData(bytes32):(address,address)",
      [ethereum.Value.fromFixedBytes(_id)]
    ...
    return ethereum.CallResult.fromValue(
      new AccessProofTemplate__getAgreementDataResult(
        value[0].toAddress(),
        value[1].toAddress()
      )
    );
