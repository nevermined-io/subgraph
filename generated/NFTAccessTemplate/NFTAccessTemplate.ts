...
export class NFTAccessTemplate__getAgreementDataResult {
  value0: Address;
  value1: Address;
...
export class NFTAccessTemplate extends ethereum.SmartContract {
  static bind(address: Address): NFTAccessTemplate {
    return new NFTAccessTemplate("NFTAccessTemplate", address);
  }
  ...
  getAgreementData(_id: Bytes): NFTAccessTemplate__getAgreementDataResult {
    ...
    return new NFTAccessTemplate__getAgreementDataResult(
      result[0].toAddress(),
      result[1].toAddress()
    );
  }
  ...
  try_getAgreementData(
    _id: Bytes
  ): ethereum.CallResult<NFTAccessTemplate__getAgreementDataResult> {
    let result = super.tryCall(
      "getAgreementData",
      "getAgreementData(bytes32):(address,address)",
      [ethereum.Value.fromFixedBytes(_id)]
    ...
    return ethereum.CallResult.fromValue(
      new NFTAccessTemplate__getAgreementDataResult(
        value[0].toAddress(),
        value[1].toAddress()
      )
    );
